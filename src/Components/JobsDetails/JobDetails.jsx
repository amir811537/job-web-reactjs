  ...
  return (
    ...
    <div className="grid gap-4 md:grid-cols-4">
      <div className="border md:col-span-3 p-6">
        ...
        <h2 className="text-2xl font-extrabold">Job Title: {job.job_title}</h2>
        <p className="py-6 font-bold">Job Description: {job.job_description}</p>
        <p className="py-4 font-bold">Job Responsibility: {job.job_responsibility}</p>
        <p className="py-4 font-bold">Educational Requirements: Bachelor in any Discipline</p>
